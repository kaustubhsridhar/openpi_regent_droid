...
def compute_and_save_simple_norm_stats_for_regent(num_retrieved):
    norm_stats_basic_file_save_loc = "assets/norm_stats_simple.json"
    max_distance_file_save_loc = "assets/max_distance.json"

    outer_dir = "regent_droid_preprocessing/collected_demos_training"
...
def convert_simple_norm_stats_to_retrieved_and_query_norm_stats(norm_stats_basic_file, num_retrieved):
    ...
    for file in ["assets/pi0_fast_droid_regent/droid/norm_stats.json",
                 "assets/pi0_fast_droid_regent_with_interpolation/droid/norm_stats.json",
                 "assets/pi0_fast_droid_regent_with_interpolation_longer_act_horizon/droid/norm_stats.json",
                 "assets/pi0_fast_droid_regent_with_interpolation_lamda1/droid/norm_stats.json",
                ]:
...
if __name__ == "__main__":
    ...
    output_file_name = compute_and_save_simple_norm_stats_for_regent(num_retrieved = num_retrieved)
