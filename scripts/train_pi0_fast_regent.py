...
def train_step(
    ...
    batch: tuple[_model.RegentObservation, _model.Actions],
    ...
    @at.typecheck
    def loss_fn(
        model: _model.BaseModel, rng: at.KeyArrayLike, observation: _model.RegentObservation, actions: _model.Actions
    ):
