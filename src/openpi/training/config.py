        ...
        model_transforms = _transforms.Group(
                    inputs=[
                        ...
                        _transforms.TokenizeFASTInputsRegent(
                            _tokenizer.FASTTokenizerRegent(max_len = model_config.max_token_len, action_horizon=model_config.action_horizon, action_dim=model_config.action_dim),
...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi0_fast_droid_regent_with_interpolation",
        # Here is an example of loading a pi0-FAST model for full finetuning.
        # Modify action_dim and action_horizon to match your dataset (action horizon is equal to
        # the desired action chunk length).
        # The max_token_len is the maximum number of (non-image) tokens the model can handle.
    ...
    TrainConfig(
        name="pi0_fast_droid_regent_with_interpolation_longer_act_horizon___finetune_on_bagel",
        finetuning_collected_demos_dir="regent_droid_preprocessing/collected_demos/2025-04-07_pick_up_the_bagel_and_put_it_in_the_toaster",
        model=pi0_fast_regent.Pi0FASTRegentConfig(action_dim=8, action_horizon=15, max_token_len=250, num_retrieved_observations=4, use_action_interpolation=True, lamda=10.0),
        data=RegentDroidDataConfig(repo_id=None, assets=AssetsConfig(asset_id="droid"), base_config=DataConfig(prompt_from_task=False)),
        weight_loader=weight_loaders.CheckpointWeightLoader("checkpoints/pi0_fast_droid_regent_with_interpolation_longer_act_horizon/14th_try_with_interpolation_longer_act_horizon/5400/params"),
        num_train_steps=1_000,
    ...
    TrainConfig(
        name="pi0_fast_droid_regent_with_interpolation_longer_act_horizon___finetune_on_lever",
        finetuning_collected_demos_dir="regent_droid_preprocessing/collected_demos/2025-04-07_push_the_lever_on_the_toaster",
        model=pi0_fast_regent.Pi0FASTRegentConfig(action_dim=8, action_horizon=15, max_token_len=250, num_retrieved_observations=4, use_action_interpolation=True, lamda=10.0),
        data=RegentDroidDataConfig(repo_id=None, assets=AssetsConfig(asset_id="droid"), base_config=DataConfig(prompt_from_task=False)),
        weight_loader=weight_loaders.CheckpointWeightLoader("checkpoints/pi0_fast_droid_regent_with_interpolation_longer_act_horizon/14th_try_with_interpolation_longer_act_horizon/5400/params"),
        num_train_steps=1_000,
    ...
    TrainConfig(
        name="pi0_fast_droid_regent_with_interpolation_longer_act_horizon___finetune_on_door",
        finetuning_collected_demos_dir="regent_droid_preprocessing/collected_demos/2025-04-07_open_the_door_of_the_bottom_shelf",
        model=pi0_fast_regent.Pi0FASTRegentConfig(action_dim=8, action_horizon=15, max_token_len=250, num_retrieved_observations=4, use_action_interpolation=True, lamda=10.0),
        data=RegentDroidDataConfig(repo_id=None, assets=AssetsConfig(asset_id="droid"), base_config=DataConfig(prompt_from_task=False)),
        weight_loader=weight_loaders.CheckpointWeightLoader("checkpoints/pi0_fast_droid_regent_with_interpolation_longer_act_horizon/14th_try_with_interpolation_longer_act_horizon/5400/params"),
        num_train_steps=1_000,
    ...
    TrainConfig(
        name="pi0_fast_droid___finetune_on_bagel",
        finetuning_collected_demos_dir="regent_droid_preprocessing/collected_demos/2025-04-07_pick_up_the_bagel_and_put_it_in_the_toaster",
        model=pi0_fast.Pi0FASTConfig(action_dim=8, action_horizon=10),
        data=SimpleDataConfig(
            repo_id=None,
    ...
    TrainConfig(
        name="pi0_fast_droid___finetune_on_lever",
        finetuning_collected_demos_dir="regent_droid_preprocessing/collected_demos/2025-04-07_push_the_lever_on_the_toaster",
        model=pi0_fast.Pi0FASTConfig(action_dim=8, action_horizon=10),
        data=SimpleDataConfig(
            repo_id=None,
    ...
    TrainConfig(
        name="pi0_fast_droid___finetune_on_door",
        finetuning_collected_demos_dir="regent_droid_preprocessing/collected_demos/2025-04-07_open_the_door_of_the_bottom_shelf",
        model=pi0_fast.Pi0FASTConfig(action_dim=8, action_horizon=10),
        data=SimpleDataConfig(
            repo_id=None,
